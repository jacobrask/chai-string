(function (plugin) {
  ...
  var startsWithMethodWrapper = function (expected) {
    ...
    return this.assert(
      ...
      'expected ' + this._obj + ' to not start with ' + expected
    );
  };
  ...
  var endsWithMethodWrapper = function (expected) {
    ...
    return this.assert(
      ...
      'expected ' + this._obj + ' to not end with ' + expected
    );
  };
  ...
  chai.Assertion.addChainableMethod('equalIgnoreCase', function (expected) {
    ...
    return this.assert(
      ...
      'expected ' + this._obj + ' to not be equal to ' + expected + ' ignoring case'
    );
  });
  ...
  chai.Assertion.addChainableMethod('singleLine', function () {
    ...
    return this.assert(
      ...
      'expected ' + this._obj + ' to not be a single line'
    );
  });
  ...
  chai.Assertion.addChainableMethod('reverseOf', function(expected) {
    ...
    return this.assert(
      ...
      'expected ' + this._obj + ' to not be the reverse of ' + expected
    );
  });
  ...
  chai.Assertion.addChainableMethod('palindrome', function () {
    ...
    return this.assert(
      ...
      'expected ' + this._obj + ' to not be a palindrome'
    );
  });
